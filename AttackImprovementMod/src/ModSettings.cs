namespace Sheepy.AttackImprovementMod {
   ...
   public class ModSettings {
       ...
       * Setting can be "None", "Attack", "Location", "Critical", or "All", from simplest and quickest to heaviest and slowest.
       * "All" is currently same as "Critical". Letter case does not matter. Default "None". */
