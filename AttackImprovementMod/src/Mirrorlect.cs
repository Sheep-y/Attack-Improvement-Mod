...
namespace Sheepy.Mirrorlect {
   ...
   public class Mirrorlect {
      ...
      public Action<SourceLevels,string,object[]> WarningHandler = ( level, msg, args ) => {
      ...
      public Mirrorlect AddAssembly ( Assembly assembly, string[] namespaces = null ) { lock ( this ) {
      ...
      private void Log( SourceLevels level, string message, params object[] args ) {
         ...
         try { WarningHandler( level, message, args ); } catch ( Exception ) { }
      }
